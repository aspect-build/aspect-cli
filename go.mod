...
require (
	...
	github.com/bazelbuild/bazel-gazelle v0.41.0 // NOTE: keep in sync with fetch.bzl
...
require (
	...
	github.com/charmbracelet/huh/spinner v0.0.0-20240821193529-5fd70815c13f // indirect
