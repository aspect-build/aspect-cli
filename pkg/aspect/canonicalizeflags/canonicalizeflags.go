...
func New(streams ioutils.Streams, bzl bazel.Bazel) *CanonicalizeFlags {
...
func (runner *CanonicalizeFlags) Run(ctx context.Context, _ *cobra.Command, args []string) error {
