...
const file_bazel_options_option_filters_proto_rawDesc = "" +
	"\n" +
	"\"bazel/options/option_filters.proto\x12\aoptions*\xea\x02\n" +
	...
	"\tIMMUTABLE\x10\a\"\x04\b\x05\x10\x05\"\x04\b\x06\x10\x06*%TRIGGERED_BY_ALL_INCOMPATIBLE_CHANGES*\x17EXPLICIT_IN_OUTPUT_PATHb\x06proto3"

var (
	file_bazel_options_option_filters_proto_rawDescOnce sync.Once
	file_bazel_options_option_filters_proto_rawDescData []byte
)

func file_bazel_options_option_filters_proto_rawDescGZIP() []byte {
	file_bazel_options_option_filters_proto_rawDescOnce.Do(func() {
		file_bazel_options_option_filters_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_bazel_options_option_filters_proto_rawDesc), len(file_bazel_options_option_filters_proto_rawDesc)))
	})
...
var file_bazel_options_option_filters_proto_goTypes = []any{
...
func file_bazel_options_option_filters_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_bazel_options_option_filters_proto_rawDesc), len(file_bazel_options_option_filters_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
