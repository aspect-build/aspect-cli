...
const file_bazel_invocation_policy_invocation_policy_proto_rawDesc = "" +
	"\n" +
	"/bazel/invocation_policy/invocation_policy.proto\x12\x11invocation_policy\"V\n" +
	"\x10InvocationPolicy\x12B\n" +
	"\rflag_policies\x18\x01 \x03(\v2\x1d.invocation_policy.FlagPolicyR\fflagPolicies\"\xe3\x02\n" +
	"\n" +
	"FlagPolicy\x12\x1b\n" +
	"\tflag_name\x18\x01 \x01(\tR\bflagName\x12\x1a\n" +
	"\bcommands\x18\x02 \x03(\tR\bcommands\x12:\n" +
	"\tset_value\x18\x03 \x01(\v2\x1b.invocation_policy.SetValueH\x00R\bsetValue\x12@\n" +
	"\vuse_default\x18\x04 \x01(\v2\x1d.invocation_policy.UseDefaultH\x00R\n" +
	"useDefault\x12L\n" +
	"\x0fdisallow_values\x18\x05 \x01(\v2!.invocation_policy.DisallowValuesH\x00R\x0edisallowValues\x12C\n" +
	"\fallow_values\x18\x06 \x01(\v2\x1e.invocation_policy.AllowValuesH\x00R\vallowValuesB\v\n" +
	"\toperation\"\xd5\x01\n" +
	"\bSetValue\x12\x1d\n" +
	"\n" +
	"flag_value\x18\x01 \x03(\tR\tflagValue\x12@\n" +
	"\bbehavior\x18\x04 \x01(\x0e2$.invocation_policy.SetValue.BehaviorR\bbehavior\"\\\n" +
	"\bBehavior\x12\r\n" +
	...
	"\tnew_value\x18\x03 \x01(\tH\x00R\bnewValue\x12@\n" +
	"\vuse_default\x18\x04 \x01(\v2\x1d.invocation_policy.UseDefaultH\x00R\n" +
	"useDefaultB\x13\n" +
	"\x11replacement_valueJ\x04\b\x02\x10\x03\"\xb0\x01\n" +
	"\vAllowValues\x12%\n" +
	"\x0eallowed_values\x18\x01 \x03(\tR\rallowedValues\x12\x1d\n" +
	"\tnew_value\x18\x03 \x01(\tH\x00R\bnewValue\x12@\n" +
	"\vuse_default\x18\x04 \x01(\v2\x1d.invocation_policy.UseDefaultH\x00R\n" +
	"useDefaultB\x13\n" +
	"\x11replacement_valueJ\x04\b\x02\x10\x03"

var (
	file_bazel_invocation_policy_invocation_policy_proto_rawDescOnce sync.Once
	file_bazel_invocation_policy_invocation_policy_proto_rawDescData []byte
)
...
func file_bazel_invocation_policy_invocation_policy_proto_rawDescGZIP() []byte {
	file_bazel_invocation_policy_invocation_policy_proto_rawDescOnce.Do(func() {
		file_bazel_invocation_policy_invocation_policy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_bazel_invocation_policy_invocation_policy_proto_rawDesc), len(file_bazel_invocation_policy_invocation_policy_proto_rawDesc)))
	})
...
var file_bazel_invocation_policy_invocation_policy_proto_goTypes = []any{
...
func file_bazel_invocation_policy_invocation_policy_proto_init() {
	...
	file_bazel_invocation_policy_invocation_policy_proto_msgTypes[1].OneofWrappers = []any{
		(*FlagPolicy_SetValue)(nil),
		(*FlagPolicy_UseDefault)(nil),
		(*FlagPolicy_DisallowValues)(nil),
		(*FlagPolicy_AllowValues)(nil),
	}
	file_bazel_invocation_policy_invocation_policy_proto_msgTypes[4].OneofWrappers = []any{
		(*DisallowValues_NewValue)(nil),
		(*DisallowValues_UseDefault)(nil),
	}
	file_bazel_invocation_policy_invocation_policy_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_bazel_invocation_policy_invocation_policy_proto_rawDesc), len(file_bazel_invocation_policy_invocation_policy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
