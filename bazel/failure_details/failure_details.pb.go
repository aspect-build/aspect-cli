...
func (x *FailureDetail) GetModCommand() *ModCommand {
	if x != nil {
		if x, ok := x.Category.(*FailureDetail_ModCommand); ok {
			return x.ModCommand
		}
	}
	return nil
...
func (x *FailureDetail) GetSkyfocus() *Skyfocus {
	if x != nil {
		if x, ok := x.Category.(*FailureDetail_Skyfocus); ok {
			return x.Skyfocus
		}
	}
	return nil
...
const file_bazel_failure_details_failure_details_proto_rawDesc = "" +
	"\n" +
	"+bazel/failure_details/failure_details.proto\x12\x0ffailure_details\x1a google/protobuf/descriptor.proto\"4\n" +
	"\x15FailureDetailMetadata\x12\x1b\n" +
	"\texit_code\x18\x01 \x01(\rR\bexitCode\"\xfa#\n" +
	...
	"\bskyfocus\x18\xb9\x01 \x01(\v2\x19.failure_details.SkyfocusH\x00R\bskyfocusB\n" +
	"\n" +
	...
	"\x18CREDENTIALS_INIT_FAILURE\x10\x04\x1a\x05\xb2C\x02\b\x02\"\xb3\x06\n" +
	"\rBuildProgress\x127\n" +
	...
	"\x19BUILD_REPORT_WRITE_FAILED\x10\x02\x1a\x05\xb2C\x02\b$\"\x89\x01\n" +
	"\bSkyfocus\x122\n" +
	"\x04code\x18\x01 \x01(\x0e2\x1e.failure_details.Skyfocus.CodeR\x04code\"I\n" +
	"\x04Code\x12\x1e\n" +
	"\x13INVALID_WORKING_SET\x10\x00\x1a\x05\xb2C\x02\b\x02\x12!\n" +
	"\x16NON_WORKING_SET_CHANGE\x10\x01\x1a\x05\xb2C\x02\b\x02\"\xa3\x01\n" +
	...
	"$INVALID_EXEC_AND_PLATFORM_PROPERTIES\x10\x10\x1a\x05\xb2C\x02\b\x01\"\x8d\x0e\n" +
	"\tExecution\x123\n" +
	"\x04code\x18\x01 \x01(\x0e2\x1f.failure_details.Execution.CodeR\x04code\"\xca\r\n" +
	"\x04Code\x12\x1c\n" +
	...
	"\"SYMLINK_TREE_DELETION_IO_EXCEPTION\x10(\x1a\x05\xb2C\x02\b$\"\x04\b\b\x10\b\"\x04\b&\x10&\"\xca\x02\n" +
	"\n" +
	"Workspaces\x124\n" +
	...
	"\x04Code\x12 \n" +
	"\x15CRASH_OPTIONS_UNKNOWN\x10\x00\x1a\x05\xb2C\x02\b%\"\x04\b\x01\x10\x01\"\xe1\x02\n" +
	"\n" +
	"Filesystem\x124\n" +
	"\x04code\x18\x01 \x01(\x0e2 .failure_details.Filesystem.CodeR\x04code\"\x9c\x02\n" +
	"\x04Code\x12\x1d\n" +
	...
	"\x1cFILESYSTEM_JNI_NOT_AVAILABLE\x10\b\x1a\x05\xb2C\x02\b$\"\x04\b\x01\x10\x01\"\x04\b\x02\x10\x02\"\x04\b\a\x10\a\"\x9b\x04\n" +
	...
	"\x1eMULTIPLE_EXECUTION_LOG_FORMATS\x10\v\x1a\x05\xb2C\x02\b\x02\"\x04\b\x01\x10\x01\"\x04\b\x02\x10\x02\"\x9c\x05\n" +
	"\aCommand\x121\n" +
	...
	"\x13FOR_COMMAND_INVALID\x10\x01\x1a\x05\xb2C\x02\b\x02\"\xfb\x04\n" +
	"\x12BuildConfiguration\x12<\n" +
	"\x04code\x18\x01 \x01(\x0e2(.failure_details.BuildConfiguration.CodeR\x04code\"\xa6\x04\n" +
	"\x04Code\x12&\n" +
	...
	"&CONFIGURATION_DISCARDED_ANALYSIS_CACHE\x10\f\x1a\x05\xb2C\x02\b\x02\"\xef\x01\n" +
	"\vInfoCommand\x125\n" +
	...
	"\x15FORMAT_FUNCTION_ERROR\x10\f\x1a\x05\xb2C\x02\b\x02\"\xd7\x02\n" +
	"\vDumpCommand\x125\n" +
	"\x04code\x18\x01 \x01(\x0e2!.failure_details.DumpCommand.CodeR\x04code\"\x90\x02\n" +
	"\x04Code\x12\x1f\n" +
	...
	"\x1bSKYFRAME_MEMORY_DUMP_FAILED\x10\a\x1a\x05\xb2C\x02\b\a\"\x04\b\x06\x10\x06\"\xa8\x01\n" +
	"\vHelpCommand\x125\n" +
	...
	"\x0fFORBIDDEN_INPUT\x10\r\x1a\x05\xb2C\x02\b\x01\"\xe9\x06\n" +
	"\bAnalysis\x122\n" +
	"\x04code\x18\x01 \x01(\x0e2\x1e.failure_details.Analysis.CodeR\x04code\"\xa8\x06\n" +
	"\x04Code\x12\x1b\n" +
	...
	"\x18ANALYSIS_CACHE_DISCARDED\x10\x15\x1a\x05\xb2C\x02\b\x01\"\xd8\t\n" +
	"\x0ePackageLoading\x128\n" +
	"\x04code\x18\x01 \x01(\x0e2$.failure_details.PackageLoading.CodeR\x04code\"\x8b\t\n" +
	"\x04Code\x12\"\n" +
	...
	"\rBAD_REPO_FILE\x10 \x1a\x05\xb2C\x02\b\x01\"\x04\b\b\x10\b\"\xda\x02\n" +
	"\tToolchain\x123\n" +
	...
	"\x1a\x05\xb2C\x02\b\x01\"\xb5\x02\n" +
	"\fExternalDeps\x126\n" +
	"\x04code\x18\x01 \x01(\x0e2\".failure_details.ExternalDeps.CodeR\x04code\"\xec\x01\n" +
	"\x04Code\x12 \n" +
	...
	"\x18INVALID_EXTENSION_IMPORT\x10\x06\x1a\x05\xb2C\x02\b0\"\x90\x01\n" +
	"\rDiffAwareness\x127\n" +
	...
	"\x10DIFF_STAT_FAILED\x10\x01\x1a\x05\xb2C\x02\b$\"\xe3\x01\n" +
	"\n" +
	"ModCommand\x124\n" +
	"\x04code\x18\x01 \x01(\x0e2 .failure_details.ModCommand.CodeR\x04code\"\x9e\x01\n" +
	"\x04Code\x12\x1e\n" +
	...
	"\x10BUILDOZER_FAILED\x10\x04\x1a\x05\xb2C\x02\b\x02:f\n" +
	"\bmetadata\x12!.google.protobuf.EnumValueOptions\x18\xb6\b \x01(\v2&.failure_details.FailureDetailMetadataR\bmetadatab\x06proto3"

var (
	file_bazel_failure_details_failure_details_proto_rawDescOnce sync.Once
	file_bazel_failure_details_failure_details_proto_rawDescData []byte
)
...
func file_bazel_failure_details_failure_details_proto_rawDescGZIP() []byte {
	file_bazel_failure_details_failure_details_proto_rawDescOnce.Do(func() {
		file_bazel_failure_details_failure_details_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_bazel_failure_details_failure_details_proto_rawDesc), len(file_bazel_failure_details_failure_details_proto_rawDesc)))
	})
...
var file_bazel_failure_details_failure_details_proto_goTypes = []any{
...
func file_bazel_failure_details_failure_details_proto_init() {
	...
	file_bazel_failure_details_failure_details_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_bazel_failure_details_failure_details_proto_rawDesc), len(file_bazel_failure_details_failure_details_proto_rawDesc)),
			NumEnums:      63,
			NumMessages:   66,
			NumExtensions: 1,
			NumServices:   0,
