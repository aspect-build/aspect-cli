...
func (x *BuildEventId) GetTestProgress() *BuildEventId_TestProgressId {
	if x != nil {
		if x, ok := x.Id.(*BuildEventId_TestProgress); ok {
...
func (x *BuildEventId) GetExecRequest() *BuildEventId_ExecRequestId {
	if x != nil {
		if x, ok := x.Id.(*BuildEventId_ExecRequest); ok {
...
func (x *BuildEvent) GetTestProgress() *TestProgress {
	if x != nil {
		if x, ok := x.Payload.(*BuildEvent_TestProgress); ok {
			return x.TestProgress
		}
	}
	return nil
...
func (x *BuildEvent) GetExecRequest() *ExecRequestConstructed {
	if x != nil {
		if x, ok := x.Payload.(*BuildEvent_ExecRequest); ok {
			return x.ExecRequest
		}
	}
	return nil
...
const file_bazel_buildeventstream_build_event_stream_proto_rawDesc = "" +
	"\n" +
	"/bazel/buildeventstream/build_event_stream.proto\x12\x12build_event_stream\x1a%bazel/action_cache/action_cache.proto\x1a%bazel/command_line/command_line.proto\x1a+bazel/failure_details/failure_details.proto\x1a/bazel/invocation_policy/invocation_policy.proto\x1a1bazel/packages_metrics/package_load_metrics.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd2#\n" +
	"\fBuildEventId\x12P\n" +
	...
	"\x19coverage_actions_finished\x18\x1b \x01(\v2:.build_event_stream.BuildEventId.CoverageActionsFinishedIdH\x00R\x17coverageActionsFinished\x12S\n" +
	...
	"\x19CoverageActionsFinishedId\x1a\x0f\n" +
	"\rExecRequestIdB\x04\n" +
	"\x02id\":\n" +
	"\bProgress\x12\x16\n" +
	...
	"\x04args\x18\x01 \x03(\tR\x04args\"\xa6\x02\n" +
	"\rOptionsParsed\x12'\n" +
	...
	"\x11explicit_cmd_line\x18\x04 \x03(\tR\x0fexplicitCmdLine\x12P\n" +
	"\x11invocation_policy\x18\x05 \x01(\v2#.invocation_policy.InvocationPolicyR\x10invocationPolicy\x12\x19\n" +
	...
	"\x10strategy_details\x18\x0e \x03(\v2\x14.google.protobuf.AnyR\x0fstrategyDetails\"\x98\x01\n" +
	...
	"\rAnomalyReport\x12#\n" +
	"\rwas_suspended\x18\x01 \x01(\bR\fwasSuspended\"\xd65\n" +
	"\fBuildMetrics\x12U\n" +
	...
	"\x19dynamic_execution_metrics\x18\f \x01(\v28.build_event_stream.BuildMetrics.DynamicExecutionMetricsR\x17dynamicExecutionMetrics\x1a\xe4\x06\n" +
	"\rActionSummary\x12'\n" +
	...
	"\x17action_cache_statistics\x18\a \x01(\v2\x1c.bazel.ActionCacheStatisticsR\x15actionCacheStatistics\x1a\x95\x02\n" +
	"\n" +
	"ActionData\x12\x1a\n" +
	"\bmnemonic\x18\x01 \x01(\tR\bmnemonic\x12)\n" +
	...
	"(targets_configured_not_including_aspects\x18\x03 \x01(\x03R$targetsConfiguredNotIncludingAspects\x1a\x88\x01\n" +
	"\x0ePackageMetrics\x12'\n" +
	"\x0fpackages_loaded\x18\x01 \x01(\x03R\x0epackagesLoaded\x12M\n" +
	"\x14package_load_metrics\x18\x02 \x03(\v2\x1b.metrics.PackageLoadMetricsR\x12packageLoadMetrics\x1a\x93\x02\n" +
	"\rTimingMetrics\x12#\n" +
	...
	"#post_invocation_skyframe_node_count\x18\x04 \x01(\x05R\x1fpostInvocationSkyframeNodeCount\x1a\xb4\b\n" +
...
var (
	...
	file_bazel_buildeventstream_build_event_stream_proto_rawDescData []byte
)
...
func file_bazel_buildeventstream_build_event_stream_proto_rawDescGZIP() []byte {
	file_bazel_buildeventstream_build_event_stream_proto_rawDescOnce.Do(func() {
		file_bazel_buildeventstream_build_event_stream_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_bazel_buildeventstream_build_event_stream_proto_rawDesc), len(file_bazel_buildeventstream_build_event_stream_proto_rawDesc)))
	})
...
var file_bazel_buildeventstream_build_event_stream_proto_goTypes = []any{
...
func file_bazel_buildeventstream_build_event_stream_proto_init() {
	...
	file_bazel_buildeventstream_build_event_stream_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_bazel_buildeventstream_build_event_stream_proto_msgTypes[13].OneofWrappers = []any{
		(*File_Uri)(nil),
		(*File_Contents)(nil),
		(*File_SymlinkTargetPath)(nil),
	}
	file_bazel_buildeventstream_build_event_stream_proto_msgTypes[29].OneofWrappers = []any{
	...
	file_bazel_buildeventstream_build_event_stream_proto_msgTypes[75].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_bazel_buildeventstream_build_event_stream_proto_rawDesc), len(file_bazel_buildeventstream_build_event_stream_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   87,
			NumExtensions: 0,
			NumServices:   0,
