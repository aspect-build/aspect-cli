...
{options}",
        ...
        .subcommand(Command::new("logout").about("Log out and remove stored credentials"))
        .subcommand(Command::new("whoami").about("Show the currently authenticated user"))
}
...
pub fn resolve_auth_env(env: Option<&str>) -> miette::Result<AuthEnv> {
    match env {
